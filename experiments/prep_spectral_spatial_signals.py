...
3. In case of preparing only a particular setting, please add the --setting argument (dependent/independent/both, default: both) as an example: python prep_spectral_spatial_signals.py --dataset 'BCIC2a' --setting 'dependent'
